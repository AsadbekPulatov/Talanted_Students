...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form action="{{ route('Users.update',$data->id)}}" method="post" class="box">
                    @csrf
                    @method('PUT')
                    ...
                    <input type="password" name="password_confirmation" placeholder="Confirim Password" required />

                    <input type="submit" name="repassword" value="RePassword">
                    <br>
                    @if(isset($mes))
