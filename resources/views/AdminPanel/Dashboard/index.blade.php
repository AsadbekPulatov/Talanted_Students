            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="dark:text-white text-justify">Dashboard</h6>
                    </div>
                    <form id="filterForm" action="{{ route('AdminDashboard') }}" method="get">
                        @csrf
                                ...
                                @foreach($data as $key => $v)
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40  shadow-transparent">
                                            <div class="flex flex-row -mx-3 p-4">
                                                <div class="flex-none max-w-full">
                                                    <a href="{{ route('download.choice_users', $v->task_id) }}">
