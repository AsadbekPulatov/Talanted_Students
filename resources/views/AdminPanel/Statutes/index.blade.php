            ...
            <div class="flex-none w-full max-w-full px-3">
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="dark:text-white text-justify">Nizomlar</h6>
                    </div>
                                            ...
                                            <div class="flex px-2 py-1">
                                                <div class="flex flex-col justify-center">
                                                    <h3 class="mb-0 text-sm leading-normal dark:text-white">
                                                        <a href="{{asset("StatutesFile/".$val->location)}}" target="_blank">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-file-earmark-pdf m-4" viewBox="0 0 16 16">
...
<div fixed-plugin>
    ...
    @if($user->position=="Creator")
    <form style="display: none" action="{{ route('Statutes.update',1)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    ...
    <form style="display: none" action="{{ route('Statutes.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
